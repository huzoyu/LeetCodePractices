 ...
 * the same party, he can announce the victory and make the decision about the change in the game.
 * Given a string representing each senator's party belonging. The character 'R'
 * and 'D' represent the Radiant party and the Dire party respectively. Then if there are
 ...
 * Input: "RD"
 * Output: "Radiant"
 * Explanation: The first senator comes from Radiant and he can just ban the next senator's right
 * in the round 1.
 * And the second senator can't exercise any rights any more since his right has been banned.
 * And in the round 2, the first senator can just announce the victory since he is the only guy
 ...
 * And in the round 2, the third senator can just announce the victory since he is the only guy
 * in the senate who can vote.
 * Note:
